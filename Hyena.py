...
class Hyena(Animal):
    # create a static class variable to leep trac of the number of hyenas creawted.
    numOfHyenas = 0

    # Create the hyena sound
    hyena_sound = " laugh...laugh "

    # Create a list of the hyena names.
    list_of_hyena_names = []
    ...
    def __init__(self, name="a_name", animal_id="an_id", birth_date="2099-01-01", color="a_color", sex="a_sex",
        ...
        # Increament the static variable numOfHyenas when a new Hyena object is created.
        Hyena.numOfHyenas += 1
